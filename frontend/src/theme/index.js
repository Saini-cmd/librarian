...
const GRAPH_VARS = {
  kinds: {
    ...
    struct: "--ds-graph-struct",
    enum: "--ds-graph-enum",
    trait: "--ds-graph-trait",
    module: "--ds-graph-module",
    type: "--ds-graph-type",
    const: "--ds-graph-const",
    var: "--ds-graph-var",
    record: "--ds-graph-record",
    union: "--ds-graph-union",
    component: "--ds-graph-component",
